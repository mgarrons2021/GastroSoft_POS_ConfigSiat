      ...
      <div class="card p-fluid">
        ...
        <div class="formgrid grid">
          <div class="field col-1">
            <label for="lugar">
              <span style="font-family: impact; font-size: 13px; color: black;"> Lugar: </span> <font-awesome-icon
    ...
    <div class="col-5">
      <div class="card">
        ...
        <div class="card">
          ...
          <div class="grid">
            <div class="col-10">
              <span style="font-family: impact; font-size: 13px; color: black;"> Total Descuento Global: </span>
          ...
          <div class="grid">
            <div class="col-10">
              <span style="font-family: impact; font-size: 13px; color: black;"> Total MontoGiftCard: </span>

            </div>
            <div class="col-2">
              <span style="font-family: impact; font-size: 13px; color: black;"> {{ this.totalDescuentoGiftcard }} Bs.
              </span>
              <!-- <input type="number"  style="width: 100%" v-on:keyup="calculatetotalDescuentogiftcard()" />  -->
          ...
          <div class="grid">
            ...
            <div class="col-2">
              <span style="font-family: impact; font-size: 13px; color: black;"> {{ (this.total - this.totalDescuento
                - this.totalDescuentoAdicional - this.totalDescuentoGiftcard).toFixed(2) }} Bs. </span>
...
export default {
  ...
  methods: {
    ...
    updateTotalDescuento3() {
      this.totalDescuentoGiftcard = 0;
      //let total_actual = this.total;
      this.totalDescuentoGiftcard += parseFloat(this.descuento_giftcard) - (this.total).toFixed(2);
      this.totalDescuentoGiftcard = this.totalDescuentoGiftcard.toFixed(2);
    },
    ...
    calculateSubtotalDescuento: function (id) {
      ...
      this.carrito[id].descuento = this.carrito[id].descuento.replace(/[^0-9.]/g, '');
      const parts = this.carrito[id].descuento.split('.');
      if (parts.length > 1) {
        this.carrito[id].descuento = `${parts[0]}.${parts[1].slice(0, 2)}`;
      }
      if (parseFloat(this.carrito[id].descuento) >= 100) {
        this.carrito[id].descuento = '';
        this.mostrarAlert("ADVERTENCIA", "El descuento no puede ser mayor o igual a 100%");
      }
      this.updateTotalDescuento();
    },
    calculatetotalDescuento: function () {
      this.descuento_adicional = event.target.value;
      this.descuento_adicional = this.descuento_adicional.replace(/[^0-9.]/g, '');
      const parts = this.descuento_adicional.split('.');
      if (parts.length > 1) {
        this.descuento_adicional = `${parts[0]}.${parts[1].slice(0, 2)}`;
      }
      if (parseFloat(this.descuento_adicional) >= 100) {
        this.descuento_adicional = 0;
        this.mostrarAlert("ADVERTENCIA", "El descuento no puede ser mayor o igual a 100%");
      }
      this.updateTotalDescuento2();
    },
    calculatetotalDescuentogiftcard: function () {
      this.descuento_giftcard = event.target.value;

      this.updateTotalDescuento3();
    ...
    registerSale() {
      ...
      if ([this.cliente, this.nit_ci, this.correo].includes("")) {
        ...
        datos_de_venta = {
          ...
          total_descuento_giftcard: this.totalDescuentoGiftcard,
