      ...
      <div class="card p-fluid">
        ...
        <div class="formgrid grid">
          <div class="field col-2">
            <label for="lugar">
              <span style="font-family: impact; font-size: 16px; color: black;"> Lugar: </span>
          ...
          <template #grid="slotProps">
            <div class="grid grid-cols-6 gap-1">
              <div v-for="(item, index) in slotProps.items" :key="index">
                <div class="card m-1 border-1 surface-border align-items-center" style="width: 110px;">
                  ...
                  <div class="flex align-items-center justify-content-center">
                    <div class="row">
                      ...
                      <Button class="p-button-raised p-button-info p-button-sm mr-1 mb-1"
                        ...
                        v-on:click="addPlateDelivery(item)"></Button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="col-5">
      <div class="card">
        ...
        <DataTable :value="carrito" :scrollable="true" scrollHeight="500px" scrollDirection="both" class="mt-2"
          ...
          <Column hidden field="descuento" header="Descuento" :style="{ width: '70px' }">
            >
            <template #body="slotProps">
              <input type="number" :value="slotProps.data.descuento" style="width: 100%" v-on:keyup="
        ...
        <div class="card">
          <div class="grid">
            <div class="col-10">
              <span style="font-family: impact; font-size: 13px; color: black;"> Total: </span>
            </div>
            <div class="col-2">
              <span style="font-family: impact; font-size: 13px; color: black;"> {{ total }} Bs. </span>
...
export default {
  ...
  methods: {
    ...
    calculateSubtotal: function (id) {
      // TODO DO VALIDATE IMPUT:
      // let valor_input = event.target.value;
      // let array = valor_input.split('.')
